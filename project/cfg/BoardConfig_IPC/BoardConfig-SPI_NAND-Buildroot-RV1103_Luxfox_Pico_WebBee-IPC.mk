...
# 	Board Config
#################################################
export LF_ORIGIN_BOARD_CONFIG=BoardConfig-SPI_NAND-Buildroot-RV1103_Luxfox_Pico_WebBee.mk
# Target CHIP
...
# Kernel dts
export RK_KERNEL_DTS=rv1103g-luxfox-pico-webbee.dts
...
# Buildroot defconfig
export RK_BUILDROOT_DEFCONFIG=luxfox_pico_defconfig
...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=luxfox_rv1106_uboot_defconfig

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=luxfox_rv1106_linux_defconfig
...
export RK_PRE_BUILD_OEM_SCRIPT=luxfox-buildroot-nocsi-oem-pre.sh

# specify post.sh for delete/overlay files
export RK_PRE_BUILD_USERDATA_SCRIPT=luxfox-userdata-pre.sh

# declare overlay directory
export RK_POST_OVERLAY="overlay-luxfox-buildroot-init overlay-luxfox-buildroot-shadow overlay-luxfox-buildroot-webbee overlay-luxfox-wifibt-firmware"
